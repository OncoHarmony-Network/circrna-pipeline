...
indir=/home/zhou/t12a/PRJEB25780/raw
oudir=/home/zhou/raid/IO_RNA/PRJEB25780/fq
nthreads=20

${py} ${PIPELINE}/common/ll_fq.py ${indir} --output ${fqfile}

nohup bash ${PIPELINE}/qc/fp.sh ${fqfile} ${indir} ${oudir} ${nthreads} ${fp} ${multiqc} &> PRJEB25780_qc.log &
