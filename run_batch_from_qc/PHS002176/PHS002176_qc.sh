...
indir=/home/zhou/raid/ncbi/dbGaP-24835/RNA_phs002176/raw
oudir=/home/zhou/raid/IO_RNA/PHS002176/fq
nthreads=4

${py} ${PIPELINE}/common/ll_fq.py ${indir} --output ${fqfile}

nohup bash ${PIPELINE}/qc/fp.sh ${fqfile} ${indir} ${oudir} ${nthreads} ${fp} ${multiqc} &> PHS002176_qc.log &
