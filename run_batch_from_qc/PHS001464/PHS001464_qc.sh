...
indir=/home/zhou/raid/ncbi/dbGaP-24835/RNA_phs001464_PRJNA412284/raw
oudir=/home/zhou/raid/IO_RNA/PHS001464/fq
nthreads=20

${py} ${PIPELINE}/common/ll_fq.py ${indir} --output ${fqfile}

nohup bash ${PIPELINE}/qc/fp.sh ${fqfile} ${indir} ${oudir} ${nthreads} ${fp} ${multiqc} &> PHS001464_qc.log &
