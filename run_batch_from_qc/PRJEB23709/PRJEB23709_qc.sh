...
indir=/home/zhou/t12b/zhou/EBI/RNA/PRJEB23709/raw
oudir=/home/zhou/raid/IO_RNA/PRJEB23709/fq
nthreads=20

${py} ${PIPELINE}/common/ll_fq.py ${indir} --output ${fqfile}

nohup bash ${PIPELINE}/qc/fp.sh ${fqfile} ${indir} ${oudir} ${nthreads} ${fp} ${multiqc} &> PRJEB23709_qc.log &
