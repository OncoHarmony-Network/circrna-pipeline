...
indir=/home/zhou/raid/ncbi/dbGaP-24835/RNA_phs001623/raw
oudir=/home/zhou/raid/IO_RNA/PHS001623/fq
nthreads=20

${py} ${PIPELINE}/common/ll_fq.py ${indir} --output ${fqfile}

nohup bash ${PIPELINE}/qc/fp.sh ${fqfile} ${indir} ${oudir} ${nthreads} ${fp} ${multiqc} &> PHS001623_qc.log &
