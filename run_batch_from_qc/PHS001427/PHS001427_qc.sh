...
indir=/home/zhou/raid/ncbi/dbGaP-24835/RNA_phs001427/raw
oudir=/home/zhou/raid/IO_RNA/PHS001427/fq
nthreads=8

${py} ${PIPELINE}/common/ll_fq.py ${indir} --output ${fqfile}

nohup bash ${PIPELINE}/qc/fp.sh ${fqfile} ${indir} ${oudir} ${nthreads} ${fp} ${multiqc} &> PHS001427_qc.log &
